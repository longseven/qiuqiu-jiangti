...
# 字体统一交给 core.setup_fonts() 的降级链(原版在此处覆盖 rcParams,
# 在无 YaHei/SimHei 的 macOS/CI 上会把字体链清成 DejaVu,中文变方块)。
from .core import FONT_CHAIN as _cjk  # noqa: F401  引入即保证字体已初始化
